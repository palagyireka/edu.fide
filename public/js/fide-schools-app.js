...
async function sendResults(sender) {
  ...
  fetch("/certification/fide-schools-application", {
    method: "POST",
    ...
    .then(() => {
      document.location.href =
        "/certification/fide-schools-application/successful-application";
    })
    .catch(() => {
      document.location.href =
        "/certification/fide-schools-application/unsuccessful";
    });
}
